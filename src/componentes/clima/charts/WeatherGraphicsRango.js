...
export default class WeatherGraphicsRango extends Component {
    constructor(props) {
        super(props);
    ...
    armarTitulo() {
      ...
      var fecha = this.crearTitulo(this.state.tipoAccion['fecha_actual'],this.state.tipoAccion['fecha_pasada']);
  ...
  formatearFechaHora(fecha_hora) {
    ...
    componentDidMount() {
        ...
        .then(data => {
            ...
            var banderaHayDatos = data['variable_actual'].length == 0 ? false : true;
            ...
            dataset = {
              ...
              showInLegend: true, 
              name: "series1",
              //legendText: this.getNombreVariable() + " " +  this.state.ciudad + " [" + subtitulo + "]",
              legendText: this.getNombreVariable() + " " +  this.state.ciudad,
              dataPoints: arreglo,
            };
            ...
            var colores_ciudades_extras = ["RGB(0, 0, 0,.5)","RGB(128, 128, 128,.5)","RGB(128, 0, 0,.5)","RGB(0, 255, 0,.5)","RGB(0, 128, 0,.5)"];
            for( var i = 0; i < extras.length; i++ ) {
              ...
              dataset = {
                type: this.state.tipo_grafico,
                bevelEnabled: true,
                color: colores_ciudades_extras[i],
                toolTipContent: this.setTooltip(),
                legendMarkerType: "circle",
                showInLegend: true, 
                name: "series1",
                //legendText: this.getNombreVariable() + " " + extras[i]['ciudad'] + " [" + subtitulo + "]",
                legendText: this.getNombreVariable() + " " + extras[i]['ciudad'],
                dataPoints: arreglo,
              };
              dataset_cargados_actual.push(dataset);
        ...
        return (
          ...
          <div className="box box-primary">
            <div className="box-header with-border">
              <h3 className="box-title"> {this.getTitulo()} </h3>
