...
export default class Apiario extends Component {
    ...
    componentDidMount () {
        ...
        var url = new URL("https://backendcolmenainteligente.herokuapp.com/api/admin/estados/colmenas");
        var params = {
                                                          ...
                                                          <thead>
                                                            <tr>
                                                              ...
                                                              */}
                                                              ...
                                                              {/* /.botones */}
                                                              <th scope="col" style={{textAlign: 'center'}}> <button id={"btn-temperatura-apiario-" + this.state.apiario_id} onClick={this.handleClickTemperatura} disabled={this.state.isDesHabilitadoBtnTemperatura} className="btn btn-xs btn-warning" disabled={this.state.isDisabled} data-toggle="tooltip" data-placement="top" title="Temperatura"> <img src={process.env.PUBLIC_URL + '/images/temperatura6.png'} width={20} height={20} /> </button>  </th>
                                                              <th scope="col" style={{textAlign: 'center'}}> <button id={"btn-humedad-apiario-" + this.state.apiario_id} onClick={this.handleClickHumedad} disabled={this.state.isDesHabilitadoBtnHumedad} className="btn btn-xs btn-primary" disabled={this.state.isDisabled} data-toggle="tooltip" data-placement="top" title="Humedad"> <img src={process.env.PUBLIC_URL + '/images/humedad4.png'} width={20} height={20} /> </button> </th>
                                                              <th scope="col" style={{textAlign: 'center'}}> <button id={"btn-senial-apiario-" + this.state.apiario_id} onClick={this.handleClickSenial} disabled={this.state.isDesHabilitadoBtnSenial} className="btn btn-xs btn-info" disabled={this.state.isDisabled} data-toggle="tooltip" data-placement="top" title="Señal"> <img src={process.env.PUBLIC_URL + '/images/wifi6.png'} width={20} height={20} /> </button> </th>
