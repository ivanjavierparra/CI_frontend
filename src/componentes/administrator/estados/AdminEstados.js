...
class AdminEstados extends Component {
            ...
            <div>
                ...
                <div className="content-wrapper">
                    ...
                    <section className="content-header">
                        <h1>
                          Estado de apiarios y colmenas
                          <br/>
                          <small>Estados</small>
                          <hr/>
                        </h1>
                        <ol className="breadcrumb">
                          <li><a href="#"><i className="fa fa-heartbeat" /> Estados</a></li>
...
export default connect(null,mapDispatchToProps)(AdminEstados)