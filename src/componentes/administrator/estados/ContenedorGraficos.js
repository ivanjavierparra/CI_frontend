...
export default class ContenedorGraficos extends Component {
    ...
    componentDidMount() {
        ...
        .catch(function(error) {
            ...
            console.log("Ha ocurrido un error al tratar de obtener las colmenas del apiarios.", error);
                ...
                <div className="content-wrapper">
                      ...
                      <section className="content-header">
                          ...
                          <ol className="breadcrumb">
                              ...
                              <li><a href="fake_url">Charts</a></li>
                          ...
                          <div className="row" style={{marginTop: 10}}>
                                ...
                                <div id="mensajes-boton-buscar" className="form-group">
                                    <div className="col-xs-12 col-md-12 col-lg-12">
                                        ...
                                        <Link to={{pathname: "/admin/revisaciones/tempyhum"}} data-key={"abcde"}><button  className="btn btn-xs btn-primary btn-flat pull-left" data-toggle="tooltip" data-placement="top" onClick={this.handleClickTyH} title="Ir a Temperatura y Humedad"><strong> Temperatura y Humedad <i className="fa fa-chevron-circle-right" /></strong></button></Link>
                                        :
                                        <Link to={{pathname: "/admin/senal"}} data-key={"abcdee"}><button  className="btn btn-xs btn-primary btn-flat pull-left" data-toggle="tooltip" onClick={this.handleClickSenal} data-placement="top" title="Ir a Señal"><strong> Señal <i className="fa fa-chevron-circle-right" /></strong></button></Link>
                                        }
                                    </div>
