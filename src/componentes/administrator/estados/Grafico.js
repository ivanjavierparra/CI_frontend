            ...
            if( this.state.variable == "temperatura" || this.state.variable == "temperatura_y_humedad" ) {
                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion']  }  );
                  }
                }
                ...
                var dataset = {
                  ...
                  toolTipContent: "Colmena: {colmena}<br>{horario}<br>Temperatura: {y}°C",
             ...
             if( this.state.variable == "humedad" || this.state.variable == "temperatura_y_humedad" ) {
                 ...
                 var dataset = {
                   ...
                   toolTipContent: "Colmena: {colmena}<br>{horario}<br>Humedad: {y}%",
                   //indexLabel: "{y}'%'",
