...
export default class WeatherGraphicsDia extends Component {
    constructor(props) {
        super(props);
        ...
        .then(data => {
            ...
            for( var i = 0; i < extras.length; i++ ) { 
              ...
              dataset = {
                ...
                showInLegend: true, 
                name: "series1",
                legendText: extras[i]['ciudad'] + " " + fecha_pasada,
                axisXType: "secondary", 
                dataPoints: arreglo,
              };
              dataset_cargados_actual.push(dataset);
            ...
            for( var i = 0; i < extras.length; i++ ) {
              ...
              dataset = {
                ...
                showInLegend: true, 
                name: "series1",
                legendText: extras[i]['ciudad'] + " " + fecha_actual,
                dataPoints: arreglo,
              };
              dataset_cargados_actual.push(dataset);
