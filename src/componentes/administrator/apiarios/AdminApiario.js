...
class AdminApiario extends Component {
  /**
    ...
    for( var i=0; i < apiarios.length; i++ ) {
        ...
        return function() {
            ...
            this.setState({
                ...
                localidad : apiarios[i]['apiario']["localidad_chacra"],
        ...
        <div className="content-wrapper">
          ...
          <section className="content-header">
            <h1>
              Apiarios
              <br />
              <small>Detalle de los Apiarios</small>
              <hr />
            </h1>
              ...
              <div className="col-md-6">
                  <div className="box box-primary">
                    ...
                    <div className="box-body">
                        ...
                        {/* /.box-body */}
                        <div className="form-group">
                          <button type="button" className="btn btn-primary btn-flat" onClick={this.handleClickBuscar}> 
                            <strong>
                              Buscar
                            </strong>
                          </button>
...
export default connect(null,mapDispatchToProps)(AdminApiario)