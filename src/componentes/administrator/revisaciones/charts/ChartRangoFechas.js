...
export default class ChartRangoFechas extends Component {
    constructor(props) {
        super(props);
            ...
            if( this.state.variable == "temperatura" || this.state.variable == "temperatura_y_humedad" ) {
                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    if( datos[i][2] == "amarillo" ) {
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], apiario: this.state.apiario['direccion_chacra'], estado: "Alerta", markerColor: "orange", markerType: "cross" }   );
                    }
                    else if( datos[i][2] == "rojo" ) { 
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], apiario: this.state.apiario['direccion_chacra'], estado: "Peligro", markerColor: "red", markerType: "cross" }   );
                    }
                    else {
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], apiario: this.state.apiario['direccion_chacra'], estado: "Correcto" }  );
                    }
                  }
                }
             ...
             if( this.state.variable == "humedad" || this.state.variable == "temperatura_y_humedad" ) {
                 ...
                 for( var i=0; i<datos.length; i++ ) {
                   if( datos[i][1] == null ) {
                    ...
                    if( datos[i][2] == "amarillo" ) {
                      ...
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], apiario: this.state.apiario['direccion_chacra'] }  );
                    }
                   }
                 }
                 ...
                 var dataset = {
                   ...
                   toolTipContent: "Colmena: {colmena}<br>Apiario: {apiario}<br>{horario}<br>Humedad: {y}%",
                   //indexLabel: "{y}'%'",
             ...
             if( this.state.variable_ambiental == "humedad" || this.state.variable_ambiental == "temperatura_y_humedad") {
                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), horario: datos[i][0], Hambiental: "Humedad Ambiental" }  );
                  }
                }
