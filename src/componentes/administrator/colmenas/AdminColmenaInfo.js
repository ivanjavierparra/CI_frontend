...
export default class AdminColmenaInfo extends Component {
    constructor(props) {
        super(props);
    ...
    descompletarCampos() {
      ...
      document.getElementById("spinner-estado-colmenas-" + this.state.colmena['id']).style.display = "none";
      document.getElementById("txt-msj-" + this.state.colmena['id']).innerText = "No hay revisaciones.";
      document.getElementById("txt-msj-temperatura-" + this.state.colmena['id']).innerText = "";
      document.getElementById("txt-msj-humedad-" + this.state.colmena['id']).innerText = "";
    }
        ...
        return (
          ...
          <div className="box box-primary">
            ...
            <div id={"box-body-" + this.state.colmena['id']} className="box-body">
                  ...
                  <strong><i className="fa fa-forumbee margin-r-5" /> Identificación </strong>
                  <p id={"txt-identificacion-" + this.state.colmena['id']} className="text-muted">
                      {this.state.colmena['identificacion'] || ''}
                  </p>
                  <hr />

                  <strong><i className="fa fa-forumbee margin-r-5" /> Raza Abeja </strong>
                  <p id={"txt-identificacion-" + this.state.colmena['id']} className="text-muted">
                      {this.state.colmena['raza_abeja'] || ''}
                  </p>
                  <hr />

                  <strong><i className="fa fa-forumbee margin-r-5" /> Fecha de Creación </strong>
                  ...
                  <strong><i className="fa fa-forumbee margin-r-5" /> Descripción </strong>
