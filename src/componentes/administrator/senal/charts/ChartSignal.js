        ...
        .then(data => {
           ...
           if ( typeof data.status !== 'undefined' ) {
            ...
            for( var i=0; i<datos.length; i++ ) {
              ...
              arreglo.push(  { x: new Date(datos[i][0]), y: parseInt(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], apiario: this.state.apiario['direccion_chacra'] } );
