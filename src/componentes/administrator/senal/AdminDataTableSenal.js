...
import ModalDetalleSenal from '../../revisaciones/ModalDetalleSenal';
export default class AdminDataTableSenal extends Component {
                ...
                <div className="content-wrapper">
                      ...
                      <section className="content-header">
                          <h1>
                              Señal
                              <br/>
                              <small>Histórico de señal de las colmenas</small>
                              <hr/>
                          </h1>

                          <ol className="breadcrumb">
                              <li><a href="fake_url"><i className="fa fa-wifi" /> Señal</a></li>
