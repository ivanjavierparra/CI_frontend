...
export default class GraficoSenial extends Component {
    ...
    crearTitulo(fecha_actual,fecha_pasada) {
      ...
      if( tipoAccion['tipo'] == "hoy" ) return "Hoy";
        ...
        var resultado = date_pasado + " --- " + date_actual; 
        return resultado;
        //return "7 días";
      }
    ...
    componentDidMount() {
        ...
        .then(data => {
            ...
            for( var i=0; i<datos.length; i++ ) {
              ...
              arreglo.push(  { x: new Date((datos[i][0]).split(" ")[0]), y: parseInt(datos[i][1]), horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion']  } );
            }
            ...
            var dataset = {
              ...
              toolTipContent: "Colmena: {colmena}<br>Fecha: {horario}<br>Señal: {y} mensajes",
            ...
            this.setState({
              options: {
                ...
                axisX: {
                  ...
                  gridThickness: 1,
                  valueFormatString: "DD-MMM-YY",//"DD-MMM-YY hh:mm tt",
                },
                axisY: [
                    {
