...
import ModalApiarioEstado from './ModalApiarioEstado';
const $ = require('jquery')

var map = [];
var markersApiarios = [];

class DataTableEstadoApiario extends Component {
            ...
            data : {  
              columns: [
                ...
                },
                {
                  ...
                  field: 'verde', // con este campo identificamos las filas.
                  sort: 'asc',
                  width: 150
                },
                {
                  label: <span>Colmenas en alerta</span>,
                  field: 'amarillo', // con este campo identificamos las filas.
                  sort: 'asc',
                  width: 150
                },
                {
                  label: <span>Colmenas en peligro</span>,
                  field: 'rojo', // con este campo identificamos las filas.
                  sort: 'asc',
                  width: 150
                },
                {
              ...
              rows: [
                {amarillo : <div> <i className="fa fa-spinner fa-pulse fa-3x fa-fw"></i></div>},
             ]
            },
        };
              ...
              this.setState(
                  ...
                  function() { 
                        ...
                        if(estados) {
                          var row = 
                              {
                                  apiario: estados['apiario'],
                                  verde: estados['verde'],
                                  amarillo: estados['amarillo'],
                                  rojo: estados['rojo'],
                                  estado: estados["estado"] == "verde" ? "Buen estado" : estados["estado"] == "amarillo" ? "Alerta" : "Peligro",
                                  consultar: <span data-toggle="modal" data-target="#modal_colmena_estado"><button id={'consultar-' + id_apiario} className="btn btn-success btn-sm fa fa-eye" onClick={this.handleClickBtnConsultar} data-toggle="tooltip" data-placement="top" title="Ver Temperatura y Humedad"> </button></span>
                              };
...
createTextSelect(direccion_chacra, nombre_fantasia) {
  ...
  <div className="content-wrapper">
    ...
    <section className="content-header">
      <h1>
        Apiarios 
        <br/>
        <small>Consultar estado de un apiario</small>
        <hr/>
      </h1>
      <ol className="breadcrumb">
        <li><a href="#"><i className="fa fa-forumbee" /> Apiarios</a></li>
            ...
            <div className="col-md-6 col-xs-12">
                ...
                <div className="box box-primary">
                  <div className="box-header with-border">
                    <h3 className="box-title">Consultar estado de un apiario<i
  ...
  <ModalApiarioEstado 
      ...
      datos={this.state.datos_colmenas}
      show={this.state.isOpenModalEstado} 
  />  
</div>
...
export default connect(null,mapDispatchToProps)(DataTableEstadoApiario)