...
export default class ColmenaChart extends Component {
    constructor(props) {
        super(props);
        ...
        this.handleClickOcultarDiv = this.handleClickOcultarDiv.bind(this);
    }
    ...
    completarCampos(revisacion) {
        ...
        document.getElementById("txt-fecha-revisacion-" + this.state.colmena['id']).innerText = "*Fecha de actualización: " + revisacion['fecha_revisacion'].split("-")[2]+"-"+revisacion['fecha_revisacion'].split("-")[1]+"-"+revisacion['fecha_revisacion'].split("-")[0] + " - " + revisacion['hora_revisacion'] + " hs.";
    }
     ...
     * 
     */
    handleClickOcultarDiv(event) {

       var visible = document.getElementById("box-body-colmena-" + this.state.colmena['id']).style.display;

       if( visible == "none" ) document.getElementById("box-body-colmena-" + this.state.colmena['id']).style.display = "block";
       else document.getElementById("box-body-colmena-" + this.state.colmena['id']).style.display = "none";
    }
          ...
          <div className="box box-primary">
            ...
            <h3 className="box-title">Colmena N° {this.state.colmena['identificacion']}</h3>
              <div className="box-tools pull-right">
                <button type="button" className="btn btn-box-tool" data-widget="collapse" onClick={this.handleClickOcultarDiv}><i className="fa fa-minus" /> </button>
            ...
            <div id={"box-body-colmena-" + this.state.colmena['id']} className="box-body">
                  ...
                  <strong><i className="fa fa-book margin-r-5" /> Raza de la Abeja </strong>
                  <p id={"txt-raza-abeja-" + this.state.colmena['id']} className="text-muted">
