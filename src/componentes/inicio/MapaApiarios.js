...
export default class MapaApiarios extends Component {
    ...
    renderMap = () => {
        ...
        window.initMap = this.initMap; // Desarrollo: AIzaSyBKOnjjR1g8kJjqPEPXN9LjxolFsQS9900     // Produccion: AIzaSyDa66qPWnvxts56tHudQJ_eQF0pZhUWPBQ
    }
    ...
    crearMarkers(apiarios) {
        ...
        for( var i=0; i < apiarios.length; i++ ) {
            ...
            var content = '<b>Apiario:</b> ' + apiarios[i]['apiario']['direccion_chacra'] + " - " + apiarios[i]['apiario']['nombre_fantasia'] + ' (' + apiarios[i]['apiario']['localidad_chacra'] + ')' + ' <br><b>Colmenas:</b> ' + apiarios[i]['colmenas'] + ' <br><b>En buen estado:</b> ' + apiarios[i]['contador']['verde'] + ' <br><b>En alerta:</b> ' + apiarios[i]['contador']['amarillo'] + ' <br><b>En peligro:</b> ' + apiarios[i]['contador']['rojo']
        ...
        <div className="col-md-12">
          <div className="box box-primary">
            <div className="box-header with-border">
              <h3 className="box-title">Estado de mis apiarios</h3>
