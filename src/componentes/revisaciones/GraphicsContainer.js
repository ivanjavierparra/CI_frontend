...
class GraphicsContainer extends Component {
    ...
    constructor(props) {
        ...
        this.handleChangeRangoHorario = this.handleChangeRangoHorario.bind(this);
        ...
        this.bucarMisColmenas = this.bucarMisColmenas.bind(this);
     ...
     * @param {*} event 
     */
    handleChangeRangoHorario(event) {
        //var opcion_seleccionada = document.getElementById("selector-horario-desde").value;
    ...
    getCantidadColmenas(apiario_id) {
        ...
        for( var i=0; i<apiarios.length; i++ ) {
            if( apiarios[i]['id_apiario'] == apiario_id ) {
                ...
                return apiarios[i]['colmenas'].length;
            }
        }
        return 0;
    }
    ...
    crear_graficos(apiario, variable, tipoAccion, variable_ambiental, titulo, tipoGrafico) {
        ...
        if( this.state.isCheckedColmena ) {
            ...
            if( tipoAccion['accion'] == "Comparacion" && tipoAccion['tipo'] == "dia" ) {
                graficos.push(<Chart apiario={apiario_seleccionado} colmena={colmena} key={colmena['id']} variable={variable} tipoAccion={tipoAccion} variable_ambiental={variable_ambiental} rango={60} titulo={titulo} tipo_grafico={tipoGrafico} columns="12" />);
            }
            else if( tipoAccion['accion'] == "Comparacion" && tipoAccion['tipo'] == "mes" ) {
                graficos.push(<ChartBar apiario={apiario_seleccionado} colmena={colmena} key={colmena['id']} variable={variable} tipoAccion={tipoAccion} variable_ambiental={variable_ambiental} rango={60} titulo={titulo} tipo_grafico={tipoGrafico} columns="12" />);
            }
            else if( tipoAccion['accion'] == "Rango" ) {
                graficos.push(<ChartBarMultiple apiario={apiario_seleccionado} colmena={colmena} key={colmena['id']} variable={variable} tipoAccion={tipoAccion} variable_ambiental={variable_ambiental} rango={60} titulo={titulo} tipo_grafico={tipoGrafico} columns="12"/>);
            }
            
        }
        else if( tipoAccion['accion'] == "Comparacion" && tipoAccion['tipo'] == "dia" ) {
            for (var i = 0; i < colmenas.length; i++) { 
                graficos.push(<Chart apiario={apiario_seleccionado} colmena={colmenas[i]} key={colmenas[i]['id']} variable={variable} tipoAccion={tipoAccion} variable_ambiental={variable_ambiental} rango={60} titulo={titulo} tipo_grafico={tipoGrafico} columns="6" />);
            }
        }
        else if( tipoAccion['accion'] == "Comparacion" && tipoAccion['tipo'] == "mes" ) {
            for (var i = 0; i < colmenas.length; i++) { 
                graficos.push(<ChartBar apiario={apiario_seleccionado} colmena={colmenas[i]} key={colmenas[i]['id']} variable={variable} tipoAccion={tipoAccion} variable_ambiental={variable_ambiental} rango={60} titulo={titulo} tipo_grafico={tipoGrafico} columns="6" />);
            }
        }
        else if( tipoAccion['accion'] == "Rango" ) {
            for (var i = 0; i < colmenas.length; i++) { 
                graficos.push(<ChartBarMultiple apiario={apiario_seleccionado} colmena={colmenas[i]} key={colmenas[i]['id']} variable={variable} tipoAccion={tipoAccion} variable_ambiental={variable_ambiental} rango={60} titulo={titulo} tipo_grafico={tipoGrafico} columns="6" />);
            }
        }
    ...
    /*
    crearCSV2(apiario_id, variable, tipoAccion, variable_ambiental) {
        var colmena_id = "";
    ...
    render() {
        ...
        let optionItems = apiarios.map((apiario) =>
                !apiario.nombre_fantasia ?
                <option key={apiario.id_apiario} data-key={apiario.id_apiario} data-colmenas={apiario.colmenas} value={apiario.id_apiario}> {apiario.direccion_chacra} - ({apiario.localidad_chacra})</option>
                :
                <option key={apiario.id_apiario} data-key={apiario.id_apiario} data-colmenas={apiario.colmenas} value={apiario.id_apiario}> {apiario.nombre_fantasia} - {apiario.direccion_chacra} - ({apiario.localidad_chacra})</option>
                ...
                <div className="content-wrapper">
                    ...
                    <section className="content-header">
                        <h1>
                            Revisaciones 
                            <br/>
                            <small>Temperatura y Humedad</small>
                            <hr/>
                        </h1>

                        <ol className="breadcrumb">
                            <li><a href="#"><i className="fa fa-thermometer-full" /> Revisaciones</a></li>
                            <li className="active">Temperatura y Humedad</li>
                        </ol>
...
const mapDispatchToProps = dispatch => {
  ...
  export default connect(null,mapDispatchToProps)(GraphicsContainer)
