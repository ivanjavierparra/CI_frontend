...
export default class ChartBarMultiple extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            subtitulo_2 : "",
            subtitulo_eje_x : "",
            colores_temperatura_1 : [],
            colores_temperatura_2 : [],
            colores_humedad_1 : [],
            colores_humedad_2 : [],
            /*chartData: {
                labels: [],
            ...
            this.setState(
                {
                    ...
                    humedad_1 : data.humedad_1,
                    humedad_2 : data.humedad_2,
                    backgroundColor_1 : data.backgroundColor_1,
                    backgroundColor_2 : data.backgroundColor_2,
                    subtitulo_1 : data.subtitulo_1,
                    subtitulo_2 : data.subtitulo_2,
                    subtitulo_eje_x : data.subtitulo_eje_x,
                    colores_temperatura_1 : data.colores_temperatura_1,
                    colores_temperatura_2 : data.colores_temperatura_2,
                    colores_humedad_1 : data.colores_humedad_1,
                    colores_humedad_2 : data.colores_humedad_2,
                }
            );
            ...
            if( this.state.variable == 'temperatura' ) {
                this.setState({
                    chartData : { 
                        ...
                        datasets: [
                            {
                              label:'Temperatura (C°) - [' + this.state.subtitulo_2 + ']',
                              data: data.temperatura_2,
                              backgroundColor: data.colores_temperatura_2,    
                              fill : false,
                            },
                            {
                              label:'Temperatura (C°) - [' + this.state.subtitulo_1 + ']',
                              data: data.temperatura_1,
                              backgroundColor: data.colores_temperatura_1,    
                              fill : false,
                            },
                        ],
                ...
                this.setState({
                    chartData : { 
                        ...
                        datasets: [
                            {
                              label:'Humedad (%) - [' + this.state.subtitulo_2 + ']',
                              data: data.humedad_2,
                              backgroundColor:  data.colores_humedad_2,
                              fill: false,
                            },
                            {
                              label:'Humedad (%) - [' + this.state.subtitulo_1 + ']',
                              data: data.humedad_1,
                              backgroundColor:  data.colores_humedad_1,
                              fill: false,
                            },
                        ]
                    }
                            ...
                            xAxes: [
                              {
                                ...
                                scaleLabel: {
                                  display: true,
                                  labelString: 'Días de ' + this.state.subtitulo_eje_x,
                                },
                                //stacked: true
                              },
                            ],
