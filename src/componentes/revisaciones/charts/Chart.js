                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    if( datos[i][2] == "amarillo" ) {
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_pasada, horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], estado: "Alerta", markerColor: "orange", markerType: "cross" }   );
                    }
                    else if( datos[i][2] == "rojo" ) { 
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_pasada, horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], estado: "Peligro", markerColor: "red", markerType: "cross" }   );
                    }
                    else {
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_pasada, horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], estado: "Correcto" }   );
                    }
                  }
                }
            ...
            if( this.state.variable == "temperatura" || this.state.variable == "temperatura_y_humedad") {
                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    if( datos[i][2] == "amarillo" ) {
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_actual, horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], estado: "Alerta", markerColor: "orange", markerType: "cross" }   );
                    }
                    else if( datos[i][2] == "rojo" ) { 
                      arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_actual, horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], estado: "Peligro",markerColor: "red", markerType: "cross" }   );
                    }
                    else {
                      arreglo.push(  {   x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_actual, horario: this.formatearFechaHora(datos[i][0]), colmena: this.state.colmena['identificacion'], estado: "Correcto" }  );
                    }
                  }
                }
             ...
             if( this.state.variable_ambiental == "humedad" || this.state.variable_ambiental == "temperatura_y_humedad") {
                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    arreglo.push(  { x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_pasada, horario: this.formatearFechaHora(datos[i][0]), Hatmosferica: "Humedad Atmosférica" }  );
                  }
                }
                ...
                var dataset = {
                  ...
                  color: "rgb(100, 149, 237, .5)",
                  legendMarkerType: "circle",
                  toolTipContent: "{Hatmosferica}<br>{horario}<br>Humedad: {y}%",
                  showInLegend: true, 
                  name: "series3",
            ...
            if( this.state.variable_ambiental == "humedad" || this.state.variable_ambiental == "temperatura_y_humedad") {
                ...
                for( var i=0; i<datos.length; i++ ) {
                  if( datos[i][1] == null ) {
                    ...
                    arreglo.push(  {  x: new Date(datos[i][0]), y: parseFloat(datos[i][1]), fecha: fecha_actual, horario: this.formatearFechaHora(datos[i][0]), Hatmosferica: "Humedad Atmosférica" }  );
                  }
                }
